...
const ProfileSection = () => {
  ...
  const infoItems = [
    { label: t("profile.currentTeam"), value: t("profile.currentTeamValue") },
    {
      ...
      value: t("profile.specializationValue"),
    },
  ...
  return (
    <section
      id="profile"
      className="py-20 sm:py-24 px-6 border-y border-gray-200 bg-white"
    >
          ...
          <div className="md:col-span-3 space-y-8">
            <Reveal>
              <div className="flex items-center gap-4 opacity-70">
                ...
                <span className="text-[10px] sm:text-xs font-bold tracking-[0.2em] uppercase text-[#0a122c]">
            ...
            <Reveal delay={0.3}>
              <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tight leading-tight text-center md:text-left text-[#040a18]">
                {t("profile.heading")}{" "}
                <span className="text-[#dc0000] text-shadow-red">
                  {t("profile.headingAccent")}
                </span>
              </h2>
            </Reveal>
              ...
              <div className="border-l-2 md:border-l border-[#dc0000]/30 md:border-gray-200 pl-6 md:pl-8 space-y-6">
                {infoItems.map((item, i) => (
                  <Reveal key={item.label} delay={0.5 + i * 0.1}>
                    <div>
                      <h4 className="text-[#dc0000] font-bold uppercase text-[10px] sm:text-xs tracking-wider mb-1 mt-2">
                        {item.label}
                      </h4>
