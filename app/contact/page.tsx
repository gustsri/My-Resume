      ...
      <section className="relative pt-32 sm:pt-40 pb-12 sm:pb-16 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <span className="text-[#ffc906]">
              {t("contactPage.headingAccent")}
            </span>
          </motion.h1>
            ...
            {contactChannels.map((channel, index) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-8 relative z-10">
                  <div
                    className={`p-3 sm:p-4 ${channel.color.split(" ")[0]} text-white transform -skew-x-12 group-hover:bg-white border border-transparent group-hover:border-gray-200 ${channel.color.split(" ")[1]} transition-colors shadow-sm`}
                  >
                ...
                <div
                  className={`absolute -right-6 -bottom-6 opacity-[0.03] group-hover:opacity-10 transition-opacity pointer-events-none group-hover:${channel.color.split(" ")[1].replace("text-", "text-").replace("group-hover:", "")}`}
                >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-5xl font-black italic uppercase tracking-tighter mb-4">
              {t("contactPage.resumeSection.heading")}{" "}
              <span className="text-[#dc0000]">
                {t("contactPage.resumeSection.headingAccent")}
              </span>
            </h2>
            ...
            >
              <span className="transform skew-x-12">
                {t("contactPage.resumeSection.downloadBtn")}
              </span>
            </a>
