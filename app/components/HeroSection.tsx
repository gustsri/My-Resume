...
const HeroSection = ({ scrollTo }: HeroSectionProps) => {
    ...
    return (
        <section id="hero" className="relative h-screen flex items-center justify-center overflow-hidden px-4">
            ...
            <div className="relative z-10 text-center">
                ...
                >
                    <p className="text-[8px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.3em] font-bold uppercase flex items-center gap-2 text-[#ffc906]">
                        <Radio size={10} className="animate-pulse text-[#dc0000]" /> Live Signal Connection Success
                    </p>
                </motion.div>
                ...
                >
                    <div className="flex items-center gap-2 sm:gap-4 border-l-4 border-[#ffc906] pl-3 sm:pl-4 text-left">
                        <span className="text-[9px] sm:text-sm font-bold opacity-50 uppercase text-white">Driver</span>
                        <span className="text-base sm:text-2xl font-black tracking-tight text-white">Kanitphong S.</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-4 border-l-4 border-[#dc0000] pl-3 sm:pl-4 text-left">
                        <span className="text-[9px] sm:text-sm font-bold opacity-50 uppercase text-white">Position</span>
                        <span className="text-base sm:text-2xl font-black tracking-tight uppercase text-white">Fullstack Developer</span>
                    </div>
                    <div className="flex items-center gap-2 sm:gap-4 border-l-4 border-[#dc0000] pl-3 sm:pl-4 text-left">
                        <span className="text-[9px] sm:text-sm font-bold opacity-50 uppercase text-white">Position</span>
                        <span className="text-base sm:text-2xl font-black tracking-tight uppercase text-white">System Analyst</span>
                    </div>
                </motion.div>
            </div>
            ...
            >
                <span className="text-[8px] sm:text-[10px] uppercase font-black tracking-widest mb-2 opacity-50 group-hover:opacity-100 transition-opacity text-white">Push to start</span>
