...
const HeroSection = ({ scrollTo }: HeroSectionProps) => {
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center">
        ...
        >
          <p className="text-[8px] sm:text-[10px] tracking-[0.2em] sm:tracking-[0.3em] font-bold uppercase flex items-center gap-2 text-[#ffc906]">
            <Radio size={10} className="animate-pulse text-[#dc0000]" /> Live
        ...
        >
          <div className="flex items-center gap-2 sm:gap-4 border-l-4 border-[#ffc906] pl-3 sm:pl-4 text-left">
            <span className="text-[9px] sm:text-sm font-bold opacity-50 uppercase text-white">
              Driver
            </span>
      ...
      >
        <span className="text-[8px] sm:text-[10px] uppercase font-black tracking-widest mb-2 opacity-50 group-hover:opacity-100 transition-opacity text-white">
          Push to start
        </span>
